...
class CallsControllerTest < ActionController::TestCase
  ...
  test "should create call" do
    assert_difference('Call.count') do
      post :create, call: { date: @call.date, lvm: @call.lvm, results: @call.results, rvm: @call.rvm, spoken: @call.spoken, time: @call.time }
    end
  ...
  test "should update call" do
    patch :update, id: @call, call: { date: @call.date, lvm: @call.lvm, results: @call.results, rvm: @call.rvm, spoken: @call.spoken, time: @call.time }
    assert_redirected_to call_path(assigns(:call))
  end
